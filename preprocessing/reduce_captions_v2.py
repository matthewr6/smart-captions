...
def vectorize_captions(caption_file, ext="", stopwords=set(), do_stem=True):
    ...
    with open("C:/Users/FitzL/Desktop/data/captions_lookup" + ext, "w") as f:
        f.writelines([word + '\n' for word in words])
    ...
    with open("C:/Users/FitzL/Desktop/data/captions" + ext, "w") as f:
        f.writelines([line + '\n' for line in lines])

def get_captions(filename, ext=""):
    """
...
def get_words(word_indexes, ext=""):
    ...
    if ext != '':
        ext = '_' + ext
    with open("C:/Users/FitzL/Desktop/data/captions_lookup" + ext + '.txt', "r") as f:
        reader = csv.reader(f)
        words = list(reader)
...
def main():
    ...
    caption_file = 'C:/Users/FitzL/Desktop/data/captions.csv'
    # Note:
